...
const int16_t thresholdRam = 4;
const int16_t thresholdVeer = 1;
const int16_t thresholdSwerve = 1;

// Speeds that define the behaviour of the robot in each state
const int16_t speedSearchSpin = 165;
const int16_t speedSearchDrive = 160;
const int16_t speedRecover = -160;
const int16_t speedAttack = 160;
const int16_t speedVeerLow = 50;
const int16_t speedVeerHigh = 270;
const int16_t speedRam = 400;
const int16_t speedSwerveLow = 350;
const int16_t speedSwerveHigh = 400;

// Timings that can be determined by simulation
const uint16_t timeStalemate = 3000;
const uint16_t timeSpinMin = 1000;
const uint16_t timeSpinMax = 2500;
const uint16_t timeRecover = 1000;
